            ...
            <table width="100%">
              <thead className="sticky top-0 dark:bg-grey-v-4 bg-white mb-[10px]">
                ...
                <th className="p-[10px] text-start dark:!text-[#ffffffb3] admin-table-heading">User ID</th>
                  ...
                  <th className="p-[10px] text-start dark:!text-[#ffffffb3] admin-table-heading">In BTC</th>
                  {/* <th className="p-[10px] text-start dark:!text-[#ffffffb3] admin-table-heading">Holding</th> */}
