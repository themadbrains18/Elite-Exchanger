                                        ...
                                        >
                                            ...
                                            <td className="admin-table-data">
                                                <div className="flex gap-[5px] items-center">
                                                    <div
                                                        className={`w-[7px] h-[7px] mr-[5px] rounded-full ${item?.down_status == true
                                                            ? "dark:bg-[#66BB6A] bg-[#0BB783]"
                                                            : "dark:bg-[#F44336] bg-[#F64E60]"
                                                            }`}
                                                    ></div>
                                                    <p
                                                        className={`text-[13px] font-public-sans font-normal leading-5 ${item?.down_status == true
                                            ...
                                            <td className="">
                                                <div className="inline-flex items-center gap-10">
                                                    <button
                                                        ...
                                                        className={`admin-outline-button ${item?.down_status == 0
                                                    ...
                                                    >
                                                        {item?.down_status == 0 ? "Activate " : "Inactivate"}
                                                    </button>
