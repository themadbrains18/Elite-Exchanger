    ...
    <div className="py-[20px] px-[16px] md:py-40">
      <div className="max-w-[1200px] w-full flex md:flex-row flex-col-reverse mx-auto items-center  gap-[30px] justify-between">
        <div>
          ...
          <a href="#" className="py-[10px] px-[15px] bg-primary rounded-[10px] text-white max-w-full sm:max-w-[144px] w-full inline-block text-center mt-[20px]">Register Now</a>
        </div>
        <div className="relative">
          ...
          <div className="absolute top-[34%] left-[39%]">
            <p className="text-[25px] md:text-[32px] font-semibold text-black">530 USDT</p>
