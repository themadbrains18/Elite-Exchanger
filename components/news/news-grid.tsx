...
const NewsGrid = () => {
    let gridCards = [1,1,1,1,1,1,1,1,1];
  
  return (
    <section className='pb-[60px] md:pb-[100px]'>
        <div className="container">
            <div className='mb-[30px] max-w-[721px] w-full'>
                <h1 className='sec-title !text-[19px] md:!text-[28px] md:mb-[15px] mb-[10px]'>ALL STORIES</h1>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]'>
                {
                    gridCards.map((elem,ind)=>{
                        return(
                            <Fragment key={ind}>
                                <div className='rounded-[10px] duration-300 rounded-t-[30px] hover:dark:bg-omega max-[767px]:dark:bg-omega dark:hover:shadow-none dark:shadow-none hover:shadow-[0px_1.3px_4.1px_0px_#d2d0e1] max-[767px]:shadow-[0px_1.3px_4.1px_0px_#d2d0e1] max-[767px]:shadow-[0px_0px_44px_0px_#0000000d]'>
                                    <div>
