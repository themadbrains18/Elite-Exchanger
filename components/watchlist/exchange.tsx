  ...
  return (
    <>
      <div className="p-20 md:p-40 rounded-10 bg-white dark:bg-d-bg-primary">
        ...
        <div className="py-50">
          ...
          <div className="mt-20 lg:mt-40 rounded-5 p-[10px] justify-between flex border items-center border-grey-v-1 dark:border-opacity-[15%] relative">
            <div className="">
              ...
              <input type="number" placeholder="$0" value={amount} onChange={(e) => setAmount(parseFloat(e.target?.value))} className="bg-[transparent] outline-none md-text border-l px-[5px] mt-[10px] border-h-primary" />
            </div>
            <div>
        ...
        {isConvert === false ? <button className={` solid-button w-full ${btnDisabled === true ? 'cursor-not-allowed ' : ''}`} disabled={btnDisabled} onClick={() => { priceConversion(); }}>{btnDisabled &&
