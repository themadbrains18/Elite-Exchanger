              ...
              {currentItems?.map((item, index) => {
                return (
                  <tr key={index} className=" dark:hover:bg-black-v-1  group rounded-5 hover:bg-[#FAFAFA] cursor-pointer">
                    ...
                    <td>
                      <p className="info-14-18 dark:text-white  ">{item.pricePerCoin}</p>
                    </td>
                   
                    <td>
                      <p className="info-14-18 dark:text-white  ">{item.limit}</p>
                    </td>
                   
                    <td>
                      <p className="info-14-18 dark:text-white  ">{item.Available}</p>
                    </td>
