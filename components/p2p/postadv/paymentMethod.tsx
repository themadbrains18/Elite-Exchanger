      ...
      <form onSubmit={handleSubmit(onHandleSubmit)}>
        <div className="mt-40">
          <div className="p-[15px] md:p-40 border rounded-10 border-grey-v-1 dark:border-opacity-[15%]">
            <p className="pb-6 border-b border-grey-v-3 sec-title dark:border-opacity-[15%]">{props.page !== 'user-center' ? 'Select Up to 5 methods' : 'Payment Methods'}</p>
            <div className="">
              {list?.map((item: any, index: any) => {
                return (
                  <div key={index} className="flex gap-30 py-20 md:mt-30 items-center">
