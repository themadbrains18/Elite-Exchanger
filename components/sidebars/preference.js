...
const Preference = (props) => {
    ...
    /**
     * Handles the setting of the mode in localStorage based on the user's selection.
     * 
     * This function is triggered by a click event and extracts the mode (e.g., 'dark' or 'light') 
     * from the clicked element, converts it to lowercase, and stores it in the localStorage.
     *
     * @param {React.MouseEvent<HTMLButtonElement>} e - The click event triggered by the user interaction.
     * 
