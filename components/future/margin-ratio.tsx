...
const MarginRatio = (props:fullWidth) => {
  return (
    <div className={`bg-[#fafafa] h-[297px] overflow-y-auto dark:bg-[#1a1b1f] border-l border-b dark:border-[#25262a] border-[#e5e7eb] py-[14px] px-[16px] ${props.fullWidth ? 'max-w-full':'max-w-[300px]'} w-full`}>
