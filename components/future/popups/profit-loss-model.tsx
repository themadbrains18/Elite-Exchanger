        ...
        <div className={`max-w-[calc(100%-30px)] duration-300 md:max-w-[720px] w-full p-5 md:p-[32px] z-10 fixed rounded-10 bg-white dark:bg-[#292d38] ${props.modelPopup == 1 ? 'top-[50%] opacity-1 visible' : 'top-[52%] opacity-0 invisible'}  left-[50%] translate-x-[-50%] translate-y-[-50%]`}>
            ...
            <div className=' mt-[25px] gap-[20px]'>
                <div className='max-[991px]:max-w-full max-w-[100%] w-full'>
                    ...
                    <button className="border bg-[#13c2c2] text-white dark:border-[#616161] border-[#e5e7eb] text-[14px] rounded-[4px] py-[10.5px] px-[10px] w-full max-w-full mt-[15px]" onClick={storeProfitLossData}>Confirm</button>
                </div>
            </div>
        </div>
    )
