        ...
        <div className='flex mt-[25px] gap-[20px] flex-col md:flex-row'>
            ...
            <div className='max-[991px]:max-w-full max-w-[50%] w-full dark:bg-[#30333e] bg-[#fafafa] p-[20px] relative'>
                <p className='admin-body-text !text-[16px] mb-[10px]'>Result</p>
                {
                    show == 1 &&
                    <>
                        <p className='admin-body-text !text-[16px] mb-[10px] dark:text-[#ADB1B8]'>Initial Margin</p>
                        <p className='admin-body-text !text-[16px] mb-[10px] dark:text-[#ADB1B8]'>PNL</p>
                        <p className='admin-body-text !text-[16px] dark:text-[#ADB1B8]'>ROE</p>
                    </>
                }
                {
                    show == 2 &&
