  ...
  return (
    <div className={`max-w-[calc(100%-30px)] duration-300 md:max-w-[720px] w-full p-5 md:p-[32px] z-10 fixed rounded-10 bg-white dark:bg-[#292d38] ${props.marginMode == 1 ? 'top-[50%] opacity-1 visible':'top-[52%] opacity-0 invisible'}  left-[50%] translate-x-[-50%] translate-y-[-50%]`}>
        ...
        <div className='flex items-center mt-10 gap-[15px]'>
            <button className={`w-full relative py-[12px] px-[5px] rounded-[4px] dark:bg-[#373d4e] bg-[#e5ecf0] rounded-[2px] border ${cross === 1 ? 'text-[#13c2c2] border-[#13c2c2]' : 'text-[#a3a8b7] border-[#f0f8ff00]'}`} onClick={() => { setCross(1) }}>
               <span> Cross</span>
               {
                cross === 1 &&
                <svg
            ...
            <button className={`w-full relative py-[12px] px-[5px] rounded-[4px] dark:bg-[#373d4e] bg-[#e5ecf0] rounded-[2px] border ${cross === 2 ? 'text-[#13c2c2] border-[#13c2c2]' : 'text-[#a3a8b7] border-[#f0f8ff00]'}`} onClick={() => { setCross(2) }}>
                <span> Isolated </span>
                {
                    cross === 2 &&
                    <svg
        ...
        <div className='flex bg-[#e5ecf0] dark:bg-[#3c4355] items-center justify-between relative z-[4]'>
            ...
            <div>
                <input type="text" className='bg-[#e5ecf0] dark:bg-[#3c4355] outline-none text-center inputPercent dark:text-[#fff] text-[#000]' readOnly value="20X" />
            </div>
        ...
        <RangeSlider inputId={props.inputId} thumbId={props.thumbId} lineId={props.lineId} rangetype={'X'} />
