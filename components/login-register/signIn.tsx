        ...
        <section className="bg-primary-300 lg:dark:bg-black-v-1  lg:bg-bg-primary ">
          <div className="h-full min-h-screen flex gap-5 bg-[url('/assets/register/ellipsebg.svg')] bg-[length:75%]  bg-no-repeat lg:bg-none ">
            ...
            <div className="max-w-full lg:max-w-[50%] flex flex-col justify-center w-full">
              ...
              <div className="mt-0 lg:mt-[80px] p-5  max-w-[calc(100%-30px)] mx-auto lg:mx-0 lg:bg-[transparent] lg:dark:bg-[transparent] bg-white lg:rounded-none rounded-10 dark:bg-d-bg-primary md:max-w-[562px] w-full lg:mb-0 mb-[10px]">
                ...
                <form onSubmit={handleSubmit(onHandleSubmit)}>
                  ...
                  <button type="submit" disabled={btnDisabled} className={`my-[30px] lg:my-[50px] solid-button w-full ${btnDisabled === true ? 'cursor-not-allowed ':''}`}>
                    {btnDisabled &&
