        ...
        <section className="bg-primary-300 lg:dark:bg-black-v-1  lg:bg-bg-primary overflow-hidden">
          <div className="flex min-h-screen h-full bg-[url('/assets/register/ellipsebg.svg')] bg-[length:75%]  bg-no-repeat lg:bg-none ">
            ...
            <div className="max-w-full lg:max-w-[50%] w-full">
              <div className="max-w-[522px] w-full h-full lg:px-5 max-[1023px]:mx-auto">
                ...
                <div className="lg:flex lg:h-full">
                  <div className="lg:p-0 p-5 max-w-[calc(100%-30px)] m-auto lg:bg-[transparent] lg:dark:bg-[transparent] bg-white lg:rounded-none rounded-10 dark:bg-d-bg-primary md:max-w-[522px] w-full">
