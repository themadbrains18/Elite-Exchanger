      ...
      const obj: any = [
        {
          ...
          cardPrice:
            '$' +
            `${
              ccurrentToken[0]?.marketcap &&
              ccurrentToken[0]?.marketcap?.toLocaleString('en-US')
            }`,
          cardLowHigh: '+2%',
          bg: 'blue',
        },
        {
          ...
          cardPrice:
            '$' +
            (ccurrentToken[0]?.maxSupply !== null
              ? ccurrentToken[0]?.maxSupply?.toLocaleString('en-US')
              : ccurrentToken[0]?.circulatingSupply?.toLocaleString('en-US')),
          cardLowHigh: '+2%',
          bg: 'red',
        },
        {
