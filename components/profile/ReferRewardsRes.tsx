...
const ReferRewardsRes = (props:fixSection) => {
  ...
  return (
    <div className={` ${props.show == 5 && "!left-[50%]"} ${
        props.fixed
                            ...
                            <div className='flex items-center justify-between gap-[15px]'>
                                <div>
                                    <div className='flex items-center gap-[15px]'>
                                        ...
                                        <a href='/profile/reward-detail' target='_blank' className='text-white underline md:opacity-0 md:group-hover:opacity-[1]'>Details</a>
                                    </div>
