...
/**
 * Interface for the Whitelist component props.
 */
interface WhitelistProps {
  /**
   * Function to enable or disable certain actions or buttons.
   * @param {any} value - The value to enable or disable.
   */
  setEnable: Function;
  /**
   * Function to control the visibility of a UI element (like a modal or popup).
   * @param {boolean} value - The value to show or hide the element.
   */
  setShow: Function;
  /**
   * The current whitelist data or a list of whitelisted items.
   */
  whitelist: any;
  /**
   * Function to set or update the whitelist data.
   * @param {any} whitelistData - The data to update the whitelist with.
   */
  setWhitelist: Function;
  /**
   * The session data, which might contain user information.
   * This is optional and can be undefined if no session is active.
   */
  session?: any;
}
 ...
 */
  ...
  /**
   * Handle the submission of the whitelist toggle request.
   * This function checks the user's session, encrypts the request data,
   * and makes a PUT request to update the user's whitelist status.
   * 
   * It handles session expiration and API errors, providing feedback via toast notifications.
   *
   * @async
