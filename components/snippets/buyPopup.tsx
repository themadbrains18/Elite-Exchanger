    ...
    <div ref={wrapperRef}>
      ...
      <form 
        ...
        <div className={`duration-300 max-w-[calc(100%-30px)] md:max-w-[951px] w-full z-10 fixed rounded-10 md:p-0 p-20 bg-white dark:bg-omega top-[50%] left-[50%] translate-x-[-50%] ${props.show1 ? " translate-y-[-50%] opacity-1 visible" : " translate-y-[-55%] opacity-0 invisible"}`}>
          <div className="flex items-center justify-end md:px-20 md:pb-10 md:pt-5">
            <svg
              onClick={() => {
                props?.setShow1(0);
                setSpendAmount('')
          ...
          <div className="   md:px-40 md:pt-20 md:pb-30 flex md:flex-row flex-col gap-[15px] items-start md:items-center justify-end">
            {/* <p className="sm-text text-start">The Trading Password is Required</p> */}
            {session &&
            <div className="border-t-[0.5px] border-grey-v-1 w-full text-right pt-[30px]">
