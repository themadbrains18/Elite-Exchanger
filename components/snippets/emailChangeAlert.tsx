...
const EmailChangeAlert = (props: changeProps) => {
    ...
    return (
        <div ref={wrapperRef} className='p-6 fixed max-h-[calc(100%-124px)] overscroll-none	 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  rounded-[10px] bg-white  z-[99] max-w-[calc(100%-36px)] md:max-w-[520px] w-full overflow-auto'>
