    ...
    return (
        <>
            ...
            <div className='lg:hidden block'>
                <MainResponsivePage show={show} setShow={setShow} profileInfo1={props.profileInfo} kycInfo={props.kycInfo} referalList={props.referalList} activity={props?.activity} />
            </div>
        </>
    )
}
