                        ...
                        {currentItems?.length > 0 && currentItems?.map((item: any, index: any) => {
                            return (
                                <tr key={index} className=" dark:hover:bg-black-v-1  group rounded-5 hover:bg-[#FEF2F2] cursor-pointer" onClick={() => router.push(`/chart/${item.symbol}`)}>
                                    ...
                                    <td>
                                        <p className="info-14-18 !text-[14px] md:!text-[16px] dark:text-white  ">${new Intl.NumberFormat().format(item.price.toFixed(8))}</p>
                                    </td>
                                    ...
                                    <td className="max-[1023px]:hidden">
                                        <p className="info-14-18 !text-[14px] md:!text-[16px] dark:text-white">${new Intl.NumberFormat().format(item.maxSupply)}</p>
                                    </td>
                                    <td className="max-[1023px]:hidden">
