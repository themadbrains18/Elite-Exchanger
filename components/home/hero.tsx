                    ...
                    <div className="heroGrid grid lg:grid-cols-2 gap-[60px] md:gap-4 ">
                        <div className="hero_left self-center max-w-[760px] w-full lg:order-1 order-2">
                            ...
                            <div className="hero_body mt-5 md:mt-30 mb-[60px] md:mb-80 ">
                                ...
                                <Link prefetch={false} className="solid-button text-[18px] max-w-full sm:max-w-[244px] w-full inline-block text-center" href="/chart/BTCB">Start Trading</Link>
                            </div>
                        ...
                        <div className="hero_right w-full max-w-[820px] lg:flex lg:items-center order-1 lg:order-2">
                            <Image src={`/assets/home/${mode === "light" ? "BannerLight1.webp" : "BannerDark1.webp"}`}
                                sizes="(max-width: 750px) 100vw, 750px"

                                quality={75} alt="Laptop-image" className="block w-full" priority width={653} height={500} />
                        </div>
                    </div>
                    <div className="lg:hidden">
                        <Swiper
                            className="mySwiper tmbMySwiper"
                            slidesPerView={2}
                            spaceBetween={20}
                            autoplay={{
                                delay: 2500
